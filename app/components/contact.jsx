...
export default function Contact() {
  ...
  return (
    <div className="isolate bg-lightGray px-6 py-24 sm:py-32 lg:px-8">
      <div
        aria-hidden="true"
      ...
      <div className="mx-auto max-w-2xl text-center">
        <h2 className="text-4xl font-semibold tracking-tight text-balance text-white sm:text-5xl">Napisz do nas</h2>
        <p className="mt-2 text-lg/8 text-white">Wypełnij poniższy formularz kontaktowy, aby być pierwszym, który weźmie udział w projekcie.</p>
      </div>
        ...
        <div className="grid grid-cols-1 gap-x-8 gap-y-6 sm:grid-cols-2">
          ...
          <Field className="flex gap-x-4 sm:col-span-2">
            ...
            <Label className="text-sm/6 text-white">
              ...
              <a href="#" className="font-semibold text-darkGreen hover:underline">
